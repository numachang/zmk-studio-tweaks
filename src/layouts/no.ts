// =============================================================================
// Norsk (Norwegian) host-layout overrides
// =============================================================================
// AUTO-GENERATED from upstream norwegian.py
...
const entries: [number, LayoutOverride][] = [
  ...
  [hid(KBD, 51), { short: "Ø" }],  // SEMI
  [hid(KBD, 52), { short: "Æ" }],  // SQT
...
export const NO_OVERRIDES: LayoutOverrideMap = new Map(entries);
