// =============================================================================
// Schweiz / Suisse (Swiss) host-layout overrides
// =============================================================================
// AUTO-GENERATED from upstream swiss.py
...
const entries: [number, LayoutOverride][] = [
  ...
  [hid(KBD, 47), { short: "ü  è  [ è  ü" }],  // LBKT
  [hid(KBD, 48), { short: "\" !" }],  // RBKT
  [hid(KBD, 51), { short: "ö  é é  ö" }],  // SEMI
  [hid(KBD, 52), { short: "ä  à  { à  ä" }],  // SQT
...
export const CH_OVERRIDES: LayoutOverrideMap = new Map(entries);
