// =============================================================================
// Español (Spanish) host-layout overrides
// =============================================================================
// AUTO-GENERATED from upstream spanish.py
...
const entries: [number, LayoutOverride][] = [
  ...
  [hid(KBD, 49), { short: "Ç" }],  // BSLH
  [hid(KBD, 50), { short: "Ç" }],  // NUHS
...
export const ES_OVERRIDES: LayoutOverrideMap = new Map(entries);
