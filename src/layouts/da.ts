// =============================================================================
// Dansk (Danish) host-layout overrides
// =============================================================================
// AUTO-GENERATED from upstream danish.py
...
const entries: [number, LayoutOverride][] = [
  ...
  [hid(KBD, 51), { short: "Æ" }],  // SEMI
  [hid(KBD, 52), { short: "Ø" }],  // SQT
...
export const DA_OVERRIDES: LayoutOverrideMap = new Map(entries);
